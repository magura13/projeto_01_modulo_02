...
let elementoBtn = document.querySelector('.botao') /* Cria a variável elementoBtn e coloca o elemento com o id alterar nela */
...
elementoBtn.addEventListener('click', () =>{
    ...
    if(elementoBtn.value == 'primeiro'){
        elementoImg.src = './assets/img/orbea_oiz.jpg' /* Troca a imagem */
        elementoNome.innerText = 'Orbea-Oiz AXS' /* Altera o texto do elemento nome */
        ...
        elementoNome.innerText = 'Cannondale HI Mod' /* Altera o texto do elemento nome */
